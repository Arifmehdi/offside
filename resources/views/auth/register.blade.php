...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('dashboard') }}/files/assets/icon/themify-icons/themify-icons.css">
    <!-- ico font -->
    <link rel="stylesheet" type="text/css" href="{{ asset('dashboard') }}/files/assets/icon/icofont/css/icofont.css">
    <!-- Style.css -->
                ...
                <div class="col-sm-12">
                    <form class="md-float-material form-material" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="text-center">
                            <img src="{{ asset('dashboard') }}/files/assets/images/offside_logo_02.png" alt="logo.png">
                        </div>
                        <div class="auth-box card">
                            <div class="card-block">
                                ...
                                <div class="row">
                                    <div class="col-md-10">
                                        <p class="text-inverse text-left m-b-0">Already Account ? <span style="border-bottom:1px solid black"><a href="{{ url('/login')}}"> <strong>Sign In</strong></a></span></p>
                                        <p class="text-inverse text-left"><a href="{{ route('web.home') }}"><b class="f-w-600">Back
                                                    to website</b></a></p>
                                    </div>
                                    <div class="col-md-2">
                                        <img src="{{ asset('dashboard') }}/files/assets/images/auth/Logo-small-bottom.png"
                                            alt="small-logo.png">
                                    </div>
                                </div>
                            </div>
...
<![endif]-->
    ...
    <!-- i18next.min.js -->
    <script type="text/javascript" src="{{ asset('dashboard') }}/files/bower_components/i18next/i18next.min.js"></script>
    <script type="text/javascript"
        src="{{ asset('dashboard') }}/files/bower_components/i18next-xhr-backend/i18nextXHRBackend.min.js"></script>
    <script type="text/javascript"
        src="{{ asset('dashboard') }}/files/bower_components/i18next-browser-languagedetector/i18nextBrowserLanguageDetector.min.js"></script>
    <script type="text/javascript" src="{{ asset('dashboard') }}/files/bower_components/jquery-i18next/jquery-i18next.min.js"></script>
    <script type="text/javascript" src="{{ asset('dashboard') }}/files/assets/js/common-pages.js"></script>
</body>
