                ...
                <div class="row">
                            ...
                            <div class="card-block">
                                <div class="row m-b-30">
                                    <div class="col-auto p-r-0">
                                        <i
                                            class="feather icon-bell bg-simple-c-blue feed-icon"></i>
                                    </div>
                                    <div class="col">
                                        <h6 class="m-b-5">You have 3 pending tasks. <span
                                                class="text-muted f-right f-13">Just Now</span>
                                        </h6>
                                    </div>
                                </div>
                                <div class="row m-b-30">
                                    <div class="col-auto p-r-0">
                                        <i
                                            class="feather icon-shopping-cart bg-simple-c-pink feed-icon"></i>
                                    </div>
                                    <div class="col">
                                ...
                                <div class="row m-b-30">
                                    <div class="col-auto p-r-0">
                                        <i
                                            class="feather icon-file-text bg-simple-c-green feed-icon"></i>
                                    </div>
                                    <div class="col">
                                        <h6 class="m-b-5">You have 3 pending tasks. <span
                                                class="text-muted f-right f-13">Just Now</span>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card">
                            ...
                            <div class="card-block">
                                <p class="text-c-green f-w-500"><i
                                        class="feather icon-chevrons-up m-r-5"></i> 18% High
                                    than last month</p>
                                <div class="row">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card">
                            ...
                            <div class="card-block">
                                <p class="text-c-pink f-w-500"><i
                                        class="feather icon-chevrons-down m-r-15"></i> 24% High
                                    than last month</p>
                                <div class="row">
                                    <div class="col-4 b-r-default">
                                        <p class="text-muted m-b-5">Overall</p>
                    ...
                    <div class="col-xl-4 col-md-12">
                        <div class="card">
                            ...
                            <div class="card-block">
                                <p class="text-c-green f-w-500"><i
                                        class="feather icon-chevrons-up m-r-15"></i> 20% High
                                    than last month</p>
                                <div class="row">
                                    <div class="col-4 b-r-default">
                                        <p class="text-muted m-b-5">Overall</p>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover table-borderless">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><label
                                                        class="label label-success">open</label>
                                                </td>
                                            ...
                                            <tr>
                                                <td><label
                                                        class="label label-primary">progress</label>
                                                </td>
                                            ...
                                            <tr>
                                                <td><label
                                                        class="label label-danger">closed</label>
                                                </td>
                                ...
                                <div class="latest-update-box">
                                    <div class="row p-t-20 p-b-30">
                                        <div class="col-auto text-right update-meta">
                                            ...
                                            <i
                                                class="feather icon-twitter bg-info update-icon"></i>
                                        </div>
                                        <div class="col">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover">
                                                    <tr>
                                                        <td class="b-none">
                                                            <a href="#!" class="align-middle">
                                                                <img src="{{ asset('dashboard') }}/files/assets/images/avatar-2.jpg"
                                                                    alt="user image"
                                                    ...
                                                    <tr>
                                                        <td class="b-none">
                                                            <a href="#!" class="align-middle">
                                                                <img src="{{ asset('dashboard') }}/files/assets/images/avatar-1.jpg"
                                                                    alt="user image"
                                                                    class="img-radius img-40 align-top m-r-15">
                                                                <div class="d-inline-block">
                                                                    <h6>John Deo</h6>
                                ...
                                <div class="latest-update-box">
                                    <div class="row p-t-20 p-b-30">
                                        <div class="col-auto text-right update-meta">
                                            ...
                                            <i
                                                class="feather icon-sunrise bg-simple-c-blue update-icon"></i>
                                        </div>
                                        <div class="col">
                                            <h6>John Deo</h6>
                                            <p class="text-muted m-b-15">The trip was an amazing
                                                and a life changing experience!!</p>
                                            <img src="{{ asset('dashboard') }}/files/assets/images/mega-menu/01.jpg"
                                                alt="" class="img-fluid img-100 m-r-15 m-b-10">
                                            <img src="{{ asset('dashboard') }}/files/assets/images/mega-menu/03.jpg"
                                                alt="" class="img-fluid img-100 m-r-15 m-b-10">
                                        </div>
                                    </div>
                                    <div class="row p-b-30">
                                        <div class="col-auto text-right update-meta">
                                            ...
                                            <i
                                                class="feather icon-file-text bg-simple-c-blue update-icon"></i>
                                        </div>
                                        <div class="col">
                                            <h6>Administrator</h6>
                                    ...
                                    <div class="row p-b-30">
                                        <div class="col-auto text-right update-meta">
                                            ...
                                            <i
                                                class="feather icon-map-pin bg-simple-c-blue update-icon"></i>
                                        </div>
                                        <div class="col">
                                            <h6>Jeny William</h6>
                    ...
                    <div class="col-xl-4 col-md-12">
                            ...
                            <div class="card-block">
                                <div class="row per-task-block text-center">
                                    <div class="col-6">
                                        ...
                                        <button
                                            class="btn btn-primary btn-round btn-sm">Manage</button>
                                    </div>
                                    <div class="col-6">
                                        <div data-label="30%"
                        ...
                        <div class="card feed-card">
                            ...
                            <div class="card-block">
                                ...
                                <div class="row m-b-25">
                                    <div class="col-auto p-r-0">
                                        <img src="{{ asset('dashboard') }}/files/assets/images/mega-menu/02.jpg"
                                            alt="" class="img-fluid img-50">
                                    </div>
                                    <div class="col">
